...
| B-02  | `@assemblejs/core` shell: exports map, tsup build, the vocabulary in one module and nowhere else                                                                                                                                                        | `pnpm --filter @assemblejs/core build && node -e "import('@assemblejs/core')"`                                                                                                |
